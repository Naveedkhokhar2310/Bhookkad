...
<body>
    <div class="signimg">
        <div>
    <div class="formdiv">
        <h1> Login to Bhookkad</h1>
        <form action="validation.php" method="POST" name="Sign-in Form">
         <!--   <table align="center" cellspacing="20" cellpadding="20">
                <tr>
                   ...
                   <b> <td class="labels">-->
                        ...
                        <input type="submit" name="submit" id="submitbtn" class="submitbtn" value="Login"/>
